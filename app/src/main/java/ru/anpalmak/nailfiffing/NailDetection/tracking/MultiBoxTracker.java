...
package ru.anpalmak.nailfiffing.NailDetection.tracking;
...
import ru.anpalmak.nailfiffing.NailDetection.Classifier.Recognition;
//import ru.anpalmak.nailfiffing.NailDetection.R;
...
public class MultiBoxTracker  {
 ...
 // private final BorderedText borderedText;
  ...
  public synchronized void TryNail(final Canvas canvas, Bitmap nail) {
    ...
    for (final TrackedRecognition recognition : trackedObjects) {
      ...
      canvas.drawBitmap(nail, null, trackedPos, null);
    }
  }
